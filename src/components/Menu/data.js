  ...
  return (
      ...
      <div className="data-data">
        ...
        <div className="data-input-field11">
          ...
          <input type="text" placeholder="Value" className="data-input11" />
        </div>
        <div className="data-input-field12">
          <span className="data-text24 BodyBase">
            <span>End Date</span>
          </span>
          <input type="text" placeholder="Value" className="data-input12" />
        </div>
        <div className="data-input-field13">
          <span className="data-text26 BodyBase">
            <span>Interval</span>
          </span>
          <input type="text" placeholder="Value" className="data-input13" />
        </div>
        <div className="data-input-field14">
          <span className="data-text28 BodyBase">
            <span>Price point</span>
          </span>
          <input type="text" placeholder="Value" className="data-input14" />
        </div>
        ...
        <div className="data-input-field16">
          ...
          <input type="text" placeholder="Value" className="data-input16" />
        </div>
        <div className="data-input-field17">
          <span className="data-text36 BodyBase">
            <span>Label</span>
          </span>
          <input type="text" placeholder="Value" className="data-input17" />
        </div>
        <div className="data-input-field18">
          <span className="data-text38 BodyBase">
            <span>Label</span>
          </span>
          <input type="text" placeholder="Value" className="data-input18" />
        </div>
        <div className="data-input-field19">
          <span className="data-text40 BodyBase">
            <span>Label</span>
          </span>
          <input type="text" placeholder="Value" className="data-input19" />
        </div>
        <div className="data-input-field20">
          <span className="data-text42 BodyBase">
            <span>Label</span>
          </span>
          <input type="text" placeholder="Value" className="data-input20" />
        </div>
        <div className="data-input-field21">
          ...
          <input type="text" placeholder="Value" className="data-input21" />
        </div>
